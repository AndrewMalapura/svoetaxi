...
<html>
 ...
 <body>
	...
	<div id="wr">		
		...
		<p>
		Предлагаем Вам разместить рекламу на обороте визитных карточек службы "Своё TAXI".
   ...
   со средним и выше уровнем доходов.
	...
	<p>В настоящее время мы готовы организовать распространение полиграфии по Киеву, а так же в службах наших коллег: 
	...
	По вопросам сотрудничества обращайтесь: <? echo "$contact"; ?></p>
		 </div>
		<div class="img_bot">
